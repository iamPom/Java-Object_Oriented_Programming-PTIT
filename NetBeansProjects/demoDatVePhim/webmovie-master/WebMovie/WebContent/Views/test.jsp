				...
				<div class="col">
					<div class="row">
						<button type="button" class="btn btn-info mb-3"
							data-toggle="modal" data-target="#myModal">Thêm Xuất
							Chiếu+</button>
									...
									<div class="modal-body">
										<form class="add-new-post" action="/WebMovie/XuatChieuServlet"
											...
											<div class="card-body border-bottom">
												...
												<select multiple class="form-control" id="sel_Phimc"
													name="tieuDe">
													<%
														for (Phim c : phim.getPhim()) {
													%>
													<option ><%=c.getTieuDe()%></option>
													<%
														}
													%>
												</select>
											...
											<div class="dropdown">
												<button class="btn btn-default dropdown-toggle"
													...
													Danh sách Rạp <span class="caret"></span>
												</button>
												<ul class="dropdown-menu" role="menu"
													aria-labelledby="menu1">

													<li role="presentation"><a role="menuitem"
														tabindex="-1" href="#"><select multiple
															class="form-control" id="sel_tenPhongChieu"
															name="tenRapChieu"onchange="validateSelectBox(this)">
																<%
											...
											<div class="card-body border-bottom">
												...
												<select multiple class="form-control" id="sel_tenPhongChieu"
													name="tenPhongChieu">
													<%
														for (XuatChieu c : tk.loadPhongChieu(a)) {
													%>
													<option><%=c.getTenPhongChieu()%></option>
											...
											<input class="form-control form-control-lg mb-3" type="text"
												placeholder="gioChieu" name="gioChieu">
					...
					<div class="col">
						<div class="card card-small mb-4">
							<div class="card-header border-bottom">
								<h6 class="m-0">Danh Sách Xuat Chieu</h6>
							</div>
