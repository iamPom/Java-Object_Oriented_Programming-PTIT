						...
						<div class='col-lg-9 col-md-12'>
							<div class="card card-small mb-3">
								<div class="card-body">
									...
									<form class="add-new-post" action="/WebMovie/TaiKhoanServlet"
										method="post">
										<input type="hidden" name="command" value="update"> <input
											type="hidden" name="id" value="${param.id }">
										<input class="form-control form-control-lg mb-3" type="text"
											placeholder="Tên Dang Nhap" name="tenDangNhap" value="${param.tenDangNhap }">
											 <input
											class="form-control form-control-lg mb-3" type="text"
											placeholder="Password" name="matKhau"value="${param.matKhau }">
